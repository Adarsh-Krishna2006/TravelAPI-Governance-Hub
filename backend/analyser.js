...
export const CONCEPT_MAP = {
  ...
  guestName: 'customer_identifier',
  guest_name: 'customer_identifier',
  customerName: 'customer_identifier',
  customer_name: 'customer_identifier',
  passengerName: 'customer_identifier',
  passenger_name: 'customer_identifier',
